...
final class FHKPushNotificationService: NSObject, ApplicationService {
    ...
    private var deepLinkProcessor: FHKDeepLinkRouterProtocol?
    ...
    func updateRouter(_ processor: FHKDeepLinkRouterProtocol) {
...
extension FHKPushNotificationService: UNUserNotificationCenterDelegate {
...
extension FHKPushNotificationService: MessagingDelegate {
