...
struct FHKRewardListScreen<VM: FHKRewardListScreenVM>: View {
    @State var viewModel: VM
    @NavigationRouterWrapper<FHKRoutes> private var router
    
    var body: some View {
        FHKScreenContainer(title: FHKRoutes.rewards.title) {
...
#Preview {
    FHKPreview {
        var vm = FHKRewardListScreenVM()
        FHKRewardListScreen(viewModel: vm)
            .task {
