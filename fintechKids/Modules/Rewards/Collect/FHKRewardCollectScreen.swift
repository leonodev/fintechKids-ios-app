//
//  FHKRewardCollectScreen.swift.swift
//  fintechKids
//
...
struct FHKRewardCollectScreen<VM: FHKRewardCollectScreenVM>: View {
    ...
    var body: some View {
        FHKScreenContainer(title: FHKRoutes.Titles.collectReward) {
...
#Preview {
    FHKPreview {
        let vm = FHKRewardCollectScreenVM()
        FHKRewardCollectScreen(viewModel: vm,
