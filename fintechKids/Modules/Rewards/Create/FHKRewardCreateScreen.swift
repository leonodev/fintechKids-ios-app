...
struct FHKRewardCreateScreen<VM: FHKRewardCreateScreenVM>: View {
    @State var viewModel: VM
    @NavigationRouterWrapper<FHKRoutes> private var router
    
    var body: some View {
        FHKScreenContainer(title: FHKRoutes.Titles.createReward) {
    ...
    var loadedView: some View {
        VStack {
            ...
            FHKRadioGroupField(
                title: "",
                options: FHKOptionsCommon.getOptionDurationType(),
...
#Preview {
    FHKPreview {
        let vm = FHKRewardCreateScreenVM()
        FHKRewardCreateScreen(viewModel: vm)
    }
}
