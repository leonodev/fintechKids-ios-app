...
struct FHKTaskStartScreen<VM: FHKTaskStartScreenVM>: View {
    ...
    var body: some View {
        FHKScreenContainer(title: FHKRoutes.Titles.tasks) {
            ...
            case .validation:
                viewModel.fhkModal.show(
                    onDismiss: {
                        ...
                        FHKValidatePinModalView(viewModel: viewModel)
                    }
                )
...
#Preview {
    FHKPreview {
        FHKTaskStartScreen(viewModel: FHKTaskStartScreenVM(),
