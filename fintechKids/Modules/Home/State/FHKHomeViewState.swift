...
public class FHKHomeViewState {
    ...
    public var familyState: FHKComponentStateType = .skeleton
    public var rewardsState: FHKComponentStateType = .skeleton
    public var goalMemberState: FHKComponentStateType = .skeleton
    ...
    public func getStateItemMemberComponent(memberName: String, avatarName: String) -> FHKComponentStateType {
        let isInfoComplete = !memberName.isEmpty && !avatarName.isEmpty
        return isInfoComplete ? .loaded : .error(errorNameMember)
    }
}

private extension FHKHomeViewState {
