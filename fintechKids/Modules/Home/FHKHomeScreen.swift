...
struct FHKHomeScreen<VM: FHKHomeScreenVM>: View {
    ...
    var body: some View {
        FHKScreenContainer(title: FHKRoutes.Titles.home) {
            VStack {
                ...
                .fullScreenCover(isPresented: $showPermissions) {
                    FHKPermissionRequestView(provider: viewModel.fhkCameraPermission)
                }
