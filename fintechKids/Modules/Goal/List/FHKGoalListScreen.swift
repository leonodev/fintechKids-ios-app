...
struct FHKGoalListScreen<VM: FHKGoalListScreenVM>: View {
    @State var viewModel: VM
    @NavigationRouterWrapper<FHKRoutes> private var router
    
    var body: some View {
        FHKScreenContainer(title: FHKRoutes.goals.title) {
...
#Preview {
    FHKPreview {
        let vm = FHKGoalListScreenVM()
        FHKGoalListScreen(viewModel: vm)
            .task {
