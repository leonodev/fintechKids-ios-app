//
//  FHKRegisterMembersScreen.swift
//  fintechKids
//
...
struct FHKRegisterMembersScreen<VM: FHKRegisterMembersScreenVM>: View {
    @State var viewModel: VM
    @NavigationRouterWrapper<FHKRoutes> private var router
    
    var body: some View {
        FHKScreenContainer(title: FHKRoutes.Titles.members) {
...
internal struct NewMemberContentView: View {
    @Bindable var viewModel: FHKRegisterMembersScreenVM
...
#Preview {
    FHKPreview {
        let vm = FHKRegisterMembersScreenVM()
        FHKRegisterMembersScreen(viewModel: vm)
            .task {
