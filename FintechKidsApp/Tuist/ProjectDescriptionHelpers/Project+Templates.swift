...
public extension Project {
    static func makeApp(
        ...
        return Project(
            name: name,
            options: .options(
                automaticSchemesOptions: .disabled // Desactiva los esquemas automáticos genéricos
            ),
            packages: packages,
            settings: .settings(
                base: [
                ...
                defaultConfiguration: "Dev" /// Indica a xcodebuild la configuración base por defecto
            ),
