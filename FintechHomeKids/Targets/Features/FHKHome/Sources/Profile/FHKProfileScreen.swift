...
public struct FHKProfileScreen: View {
    @State private var viewModel: FHKProfileScreenVM
    ...
    public init() {
        self._viewModel = State(initialValue: FHKProfileScreenVM())
    }
    
    
    public var body: some View {
        
        FHKScreenContainer(title: viewModel.viewState.profile) {
