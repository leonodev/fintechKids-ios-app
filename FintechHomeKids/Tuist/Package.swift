...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/leonodev/FLib-Utils.git", from: "1.0.4"),
        .package(url: "https://github.com/firebase/firebase-ios-sdk.git", from: "12.6.0"),
        .package(url: "https://github.com/leonodev/FLib-Injections.git", from: "1.0.10"),
        .package(url: "https://github.com/leonodev/FLib-Storage.git", from: "1.0.7")
    ]
)
