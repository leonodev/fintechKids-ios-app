...
@MainActor
public final class FirebaseRemoteConfigMock: FHKRemoteConfigManagerProtocol {
    ...
    public var menuHomeItems: [MenuHomeItem] {
        return [
            MenuHomeItem(id: 0, name: "payments", icon: "payments-icon", label_localized_key: "key_payments_title", active: true)
        ]
    }
